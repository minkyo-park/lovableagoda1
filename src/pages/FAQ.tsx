...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "본 사이트에서는 아고다 할인코드를 매일 확인하고 업데이트하고 있습니다. 아고다는 월 평균 8~15개의 새로운 할인코드를 발행하며, 특별 시즌(블랙프라이데이, 설/추석, 여름 휴가철 등)에는 추가 프로모션 코드가 제공됩니다. 만료된 코드는 즉시 제거하고 새로운 코드를 추가하여 항상 최신 상태를 유지하고 있으니, 정기적으로 방문하시면 최신 할인 혜택을 놓치지 않을 수 있습니다."
  },
  {
